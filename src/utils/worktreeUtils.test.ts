...
describe('column alignment', () => {
	...
	it('should calculate column positions from items', () => {
		...
		expect(positions.fileChanges).toBe(29); // 19 + 2 padding + 6 (presetName) + 2 padding
	...
	it('should assemble label with proper alignment', () => {
		...
		expect(plain.indexOf('+10 -5')).toBe(29); // Should start at column 29 (updated for presetName column)
	});
});
