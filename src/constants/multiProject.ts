...
export const MULTI_PROJECT_ENV_VARS = {
	...
	PROJECTS_DIR: 'CCMANAGER_PROJECTS_DIR',
} as const;

// Default values and messages
export const MULTI_PROJECT_DEFAULTS = {
	ERROR_NO_PROJECTS_DIR:
		'CCMANAGER_PROJECTS_DIR environment variable is required in multi-project mode',
	ERROR_INVALID_PROJECTS_DIR:
		'CCMANAGER_PROJECTS_DIR points to a non-existent directory',
